...
<div className="romb">
    ...
    <div className="logo_logo">NORN</div>       
        ...
        <div className="contacts">
                ...
                <div><a href=""><img href="public/img/instagram_black.svg" alt="instagram" width="20px" height="20px"/></a></div>
                <div><a href=""><img href="public/img/vk_black.svg" alt="vk" width="28px" height="28px"/></a></div>
                <div><a href=""><img href="public/img/facebook_black.svg" alt="facebook" width="20px" height="20px"/></a></div>
            </div>  
...
<div className="romb_norv">
    ...
    <div className="text_norv_kub_2">
        ...
        <div className="strelka"><img href="public/img/arrow_black.svg" alt="arrow" width="20px" height="26px"/></div></div>
    </div>
</div>


<div className="romb_islan">   
    <div className="foto_islan"><img href="public/img/img_reykjavik.png" alt="reykjavik" width="255px" height="255px"/></div>    
    <div className="text_yaziki_romb">ИСЛАНСКИЙ</div>
</div> 
<div className="romb_shved">
        <div className="foto_shved"><img href="public/img/img_stokgolm.png" alt="stokgolm" width="255px" height="255px"/></div>
    <div className="text_yaziki_romb">ШВЕДСКИЙ</div>
</div> 
<div className="romb_fin">
        <div className="foto_fin"><img shref="public/img/img_helsinki.png" alt="helsinki" width="255px" height="255px"/></div>
    <div className="text_yaziki_romb">ФИНСКИЙ</div>
</div> 
<div className="romb_dat">
        <div className="foto_dat"><img href="public/img/img_kopengagen.png" alt="kopengagen" width="255px" height="255px"/></div>
    ...
    <div className="container_yrovni">
            ...
            <div className="flex_yrovni">
                <div className="yrovni">
                    <div className="znachki"><img href="public/img/rombik_white.svg" alt="rombik" width="30px" height="30px"/></div>
                ...
                <div className="yrovni">
                        <div className="znachki"><img href="public/img/rombik_prozrachnyi.svg" alt="rombik" width="30px" height="30px"/></div>
                    <div className="flex_yrovni_text">
                    ...
                    <div className="yrovni">
                        ...
                        <div className="yrovni">
                            ...
                            <div className="yrovni">
                                    <div className="znachki"><img href="public/img/rombik_dvoinoi.svg" alt="rombik" width="65px" height="45px"/></div>
                                <div className="flex_yrovni_text">
...
<img href="public/img/mark3_white.svg" alt="logo" width="61px" height="61px"/>
